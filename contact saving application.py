...
class ContactApp(tk.Tk):
    def __init__(self, contact_manager):
        ...
        self.configure(bg="#ffcccb")  # Light pink background
        self.contact_manager = contact_manager

        # Main buttons
        self.add_button = tk.Button(self, text="Add Contact", command=self.show_add_contact_window, bg="#4CAF50", fg="white", font=('Arial', 12))
        self.delete_button = tk.Button(self, text="Delete Contact", command=self.show_delete_contact_window, bg="#f44336", fg="white", font=('Arial', 12))
        self.display_button = tk.Button(self, text="Display Contacts", command=self.show_display_contacts_window, bg="#008CBA", fg="white", font=('Arial', 12))
        self.search_button = tk.Button(self, text="Search Contact", command=self.show_search_contact_window, bg="#FFC107", fg="white", font=('Arial', 12))

        # Layout
        self.add_button.pack(pady=10, ipadx=10, ipady=10)
        self.delete_button.pack(pady=10, ipadx=10, ipady=10)
        self.display_button.pack(pady=10, ipadx=10, ipady=10)
        self.search_button.pack(pady=10, ipadx=10, ipady=10)
...
class AddContactWindow(tk.Toplevel):
    def __init__(self, parent, contact_manager):
        ...
        # Widgets
        self.name_label = tk.Label(self, text="Name:", font=('Arial', 12), bg="#ffcccb")
        self.name_entry = tk.Entry(self, font=('Arial', 12))
        self.phone_label = tk.Label(self, text="Phone:", font=('Arial', 12), bg="#ffcccb")
        self.phone_entry = tk.Entry(self, font=('Arial', 12))
        self.save_button = tk.Button(self, text="Save", command=self.save_contact, bg="#4CAF50", fg="white", font=('Arial', 12))
        ...
        self.save_button.pack(pady=20, ipadx=10, ipady=5)
...
class DeleteContactWindow(tk.Toplevel):
    def __init__(self, parent, contact_manager):
        ...
        self.load_contacts()
        self.delete_button = tk.Button(self, text="Delete", command=self.delete_contact, bg="#f44336", fg="white", font=('Arial', 12))

        self.contacts_listbox.pack(pady=10, fill=tk.BOTH, expand=True)
        self.delete_button.pack(pady=20, ipadx=10, ipady=5)
...
class SearchContactWindow(tk.Toplevel):
    def __init__(self, parent, contact_manager):
        ...
        self.search_label = tk.Label(self, text="Enter Name:", font=('Arial', 12), bg="#ffcccb")
        self.search_entry = tk.Entry(self, font=('Arial', 12))
        self.search_button = tk.Button(self, text="Search", command=self.search_contact, bg="#FFC107", fg="white", font=('Arial', 12))
        self.result_label = tk.Label(self, text="", font=('Arial', 12), bg="#ffcccb")
